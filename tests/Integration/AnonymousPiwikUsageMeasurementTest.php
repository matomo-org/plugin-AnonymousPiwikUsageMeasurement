...
class AnonymousPiwikUsageMeasurementTest extends IntegrationTestCase
{
    ...
    public function test_shouldAddTrackingCallsWithTargetsAndCustomVariables_IfEnabledByUser()
    {
        ...
        $out = '';
        Piwik::postEvent('Template.jsGlobalVariables', array(&$out));
        $this->assertContains('var piwikUsageTracking = {"targets":[{"url":"http:\/\/demo-anonymous.piwik.org\/piwik.php","idSite":1,"anon":true}],"visitorCustomVariables":[{"id":1,"name":"Access","value":"superuser"}],"trackingDomain":"http:\/\/demo-anonymous.piwik.org","exampleDomain":"http:\/\/example.com"}', $out);
    }
