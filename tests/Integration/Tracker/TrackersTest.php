...
class TrackersTest extends IntegrationTestCase
{
    ...
    public function test_makeTrackers_FromDefaultSettings()
    {
        ...
        $this->assertStringStartsWith('https://demo-anonymous.matomo.org/piwik.php?idsite=1&rec=1', $trackers[0]->getUrlTrackPageView());
    }
    ...
    {
        $targets = array(
            array('url' => 'https://demo-anonymous.matomo.org/piwik/piwik.php', 'idSite' => 5, 'useAnonymization' => true),
        ...
        $this->assertStringStartsWith('https://demo-anonymous.matomo.org/piwik/piwik.php?idsite=5&rec=1', $trackers[0]->getUrlTrackPageView());
        ...
        $this->assertStringEndsWith('url=https%3A%2F%2Fdemo-anonymous.matomo.org&urlref=', $trackers[2]->getUrlTrackPageView());
    }
